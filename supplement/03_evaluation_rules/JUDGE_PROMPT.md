...
- You **must not** interpret `prompt_variant` as “A/B/baseline/better/worse”. It is only a metadata label.
...
- Do not introduce prior bias based on `model`, `prompt_variant`, or `eval_set_variant`.
